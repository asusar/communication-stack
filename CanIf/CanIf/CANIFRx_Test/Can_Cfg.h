...
typedef struct {
	/*void (*CancelTxConfirmation)( const Can_PduType *);removed from AUTOSAR 2.2 */
...
/*According to misra : no variable should be declared external in two different files
 * Thus , the declaration here is cancelled as it is declared already in CanIf_Cfg.c  */
